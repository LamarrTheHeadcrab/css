...
<?php if($pun_user['is_admmod']): ?>
				<div class="inform">
					<fieldset>
						...
						<div class="infldset">
							<div class="txtarea">
								<textarea name="custom_style" rows="4" cols="65"><?php echo pun_htmlspecialchars($user['custom_style']) ?></textarea>
							</div>
						</div>
					</fieldset>
				</div>
